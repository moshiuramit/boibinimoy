...
const BuyOrRent = ({book}) => {
  return(
    <div className="flex items-center">
      <div className="m-2">
        <button className="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">Buy this book for {book.sellPrice} BDT</button>
      ...
      <div className="m-2">
        <button className="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">Rent this book for {book.rentPrice} BDT/pm</button>
