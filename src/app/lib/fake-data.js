...
const books = [
  {
    id: 'e0cdfaa6-beee-4dd9-bfe6-cbcfeceffaa4',
    title: 'River Sing Me Home',
    description: "The master of the Providence plantation in Barbados gathers his slaves and announces the king has decreed an end to slavery. As of the following day, the Emancipation Act of 1834 will come into effect. The cries of joy fall silent when he announces that they are no longer his slaves; ",
    author: 'Eleanor Shearer',
    cover: '/books/riversingmehome.jpg',
    genre: 'Novels',
    pages: 322,
    isRented: false,
    stock: 16,
  ...
  {
    id: 'e0cdfaa6-beee-4dd9-bfe6-cbcfeceffba8',
    title: 'Get in Trouble',
    description: "The most darkly playful voice in American fiction” and by Neil Gaiman as “a national treasure.” Now Kelly Link’s eagerly awaited new collection--her first for adult readers in a decade--proves indelibly that this bewitchingly original writer is among the finest we have.",
    author: 'Kelly Link',
    cover: '/books/getintrouble.jpg',
    genre: 'Novels',
    pages: 336,
    isRented: false,
    stock: 26,
